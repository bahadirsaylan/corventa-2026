...
/// <summary>
/// Service module — Soru / Öneri / Şikayet ticket'ları ve Servis Talebi/Rapor kayıtları.
/// Şimdilik local SQLite only. Cloud sync stub (ileride eklenecek).
/// </summary>
[ApiController]
...
public class ServiceController : ControllerBase
{
    ...
    /// <summary>
    /// Tip bazında ticket listesi: type=question|suggestion|complaint
    /// </summary>
    [HttpGet("tickets")]
    ...
    {
        /// <summary>"resolved" | "in-progress" | "cancelled"</summary>
        public string Action { get; set; } = "";

        /// <summary>Opsiyonel cevap/not (teknisyenden)</summary>
    ...
    public async Task<IActionResult> CreateRequest([FromBody] ServiceRequest body)
    {
        ...
        // Client'dan gelenleri temizle; oluşturma anını repo set edecek
        body.Id = 0;
    ...
    /// <summary>
    /// Servisi başlat — status Planned → InProgress, StartedAt set.
    /// </summary>
    ...
    /// <summary>
    /// Servisi bitir — rapor kodu + onay kodu üret, status Completed.
    /// Onay kodu ayrı bir endpoint ile doğrulanır (POST /confirm).
    /// </summary>
    ...
    public async Task<IActionResult> CompleteRequest(int id)
    {
        ...
        {
            // SEKIL-51 formatı: SR.22071140000101
        ...
        // Not: gerçek sistemde ConfirmCode SMS/email ile müşteriye gönderilir.
        // Şimdilik response'a dahil (development/mock).
    ...
    /// <summary>
    /// Müşteri onay kodunu girerek servisi onaylar.
    /// </summary>
